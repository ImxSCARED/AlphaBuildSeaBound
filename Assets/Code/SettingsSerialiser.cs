...
{
    // Instance
    private static SettingsSerialiser instance = null;
    public static SettingsSerialiser Instance
    {
        get
        {
            instance ??= new SettingsSerialiser();
            return instance;
        }
    }
    ...
    public bool GetSetting<T>(string key, out T value)
    {
        ...
        if (!FindKeyIndex(key, out keyIndex))
        {
            Debug.LogWarning("GetSetting: Setting " + key + " does not exist.");
            return false;
        }
    ...
    /// <summary>
    /// Writes settings to a json file in a standard save file location
    /// </summary>
    ...
    /// <summary>
    /// Reads settings from a json file in a standard save file location
    /// </summary>
